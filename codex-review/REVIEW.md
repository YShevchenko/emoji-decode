...
# Codex Review — Emoji Decode

## Product & Documentation Alignment
- Guess the phrase from the emojis. 🏠+🔑=HOUSE KEY. **Interstitials:** Shown every 3-5 levels or deaths (frequency capped to avoid instant churn).
